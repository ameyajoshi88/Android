...
public class ShowEntriesForName extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Intent i = getIntent();
		currency = i.getStringExtra("name_key");
		...
		if (c.moveToFirst()) {
			...
			Toast.makeText(getApplicationContext(), "Balance = "+balanceCount+"\nAmount = "+balanceAmount,
	...
	{     
		...
		{             
			Intent Act2Intent = new Intent(ShowEntriesForName.this, ForexTracker.class);       
